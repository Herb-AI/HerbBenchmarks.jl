function get_all_benchmarks()::Vector{Benchmark}
    ...
    modules = [ARC_AGI1, ARC_AGI2, Pixels_2020, Robots_2020, String_transformations_2020, PBE_BV_Track_2018, PBE_BV_Track_2018.Hackers_Delight, PBE_SLIA_Track_2019, DeepCoder_2016]
