function get_all_benchmarks()::Vector{Benchmark}
    ...
    modules = [Abstract_Reasoning_2019, Pixels_2020, Robots_2020, String_transformations_2020, PBE_BV_Track_2018, PBE_SLIA_Track_2019, DeepCoder_2016, Morpheus_2017]
