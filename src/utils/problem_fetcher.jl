function get_all_benchmarks()::Vector{Benchmark}
    ...
    # DreamCoder_2021 is a parent module: its sub-benchmarks are the modules
    # that actually hold problems, so they are spliced in individually.
    modules = [Abstract_Reasoning_2019, Pixels_2020, Robots_2020, String_transformations_2020,
        ...
        DreamCoder_2021.SUB_BENCHMARKS...]
