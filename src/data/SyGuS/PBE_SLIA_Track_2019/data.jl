problem_11604909 = Problem(Example[
...
problem_12948338 = Problem(Example[
...
problem_17212077 = Problem(Example[
...
problem_2171308 = Problem(Example[
...
problem_23435880 = Problem(Example[
...
problem_25239569 = Problem(Example[
...
problem_28627624_1 = Problem(Example[
...
problem_30732554 = Problem(Example[
...
problem_31753108 = Problem(Example[
...
problem_33619752 = Problem(Example[
...
problem_34801680 = Problem(Example[
...
problem_35016216 = Problem(Example[
...
problem_35744094 = Problem(Example[
...
problem_36462127 = Problem(Example[
...
problem_38664547 = Problem(Example[
	...
	IOExample(Dict{Symbol, Any}(:_arg_1 => "knowthat"), "know")])
problem_38871714 = Problem(Example[
...
problem_39060015 = Problem(Example[
...
problem_43120683 = Problem(Example[
...
problem_43606446 = Problem(Example[
...
problem_44789427 = Problem(Example[
...
problem_add_a_line_break_with_a_formula = Problem(Example[
...
problem_clean_and_reformat_telephone_numbers = Problem(Example[
...
problem_convert_text_to_numbers = Problem(Example[
	IOExample(Dict{Symbol, Any}(:_arg_1 => "101"), 101), 
	IOExample(Dict{Symbol, Any}(:_arg_1 => "1002"), 1002), 
	IOExample(Dict{Symbol, Any}(:_arg_1 => "743"), 743)])
problem_count_consecutive_monthly_orders = Problem(Example[
...
problem_count_line_breaks_in_cell = Problem(Example[
...
problem_count_specific_characters_in_a_cell = Problem(Example[
...
problem_count_specific_words_in_a_cell = Problem(Example[
...
problem_count_total_characters_in_a_cell = Problem(Example[
...
problem_count_total_words_in_a_cell = Problem(Example[
...
problem_create_email_address_from_name = Problem(Example[
...
problem_create_email_address_with_name_and_domain = Problem(Example[
...
problem_exceljet1 = Problem(Example[
...
problem_exceljet2 = Problem(Example[
...
problem_exceljet3 = Problem(Example[
...
problem_exceljet4 = Problem(Example[
...
problem_extract_nth_word_from_text_string = Problem(Example[
...
problem_extract_text_between_parentheses = Problem(Example[
...
problem_extract_word_containing_specific_text = Problem(Example[
...
problem_extract_word_that_begins_with_specific_character = Problem(Example[
...
problem_find_nth_occurrence_of_character = Problem(Example[
...
problem_get_domain_from_email_address_2 = Problem(Example[
...
problem_get_domain_name_from_url = Problem(Example[
...
problem_get_first_name_from_name_with_comma = Problem(Example[
...
problem_get_first_name_from_name = Problem(Example[
...
problem_get_first_word = Problem(Example[
...
problem_get_last_line_in_cell = Problem(Example[
...
problem_get_last_name_from_name_with_comma = Problem(Example[
...
problem_get_last_name_from_name = Problem(Example[
...
problem_get_last_word = Problem(Example[
...
problem_get_middle_name_from_full_name = Problem(Example[
...
problem_join_cells_with_comma = Problem(Example[
...
problem_join_first_and_last_name = Problem(Example[
...
problem_most_frequently_occurring_text = Problem(Example[
...
problem_phone_5_short = Problem(Example[
...
problem_phone_6_short = Problem(Example[
...
problem_phone_7_short = Problem(Example[
...
problem_phone_9_short = Problem(Example[
...
problem_position_of_2nd_3rd_etc_instance_of_character = Problem(Example[
...
problem_remove_characters_from_left = Problem(Example[
...
problem_remove_characters_from_right = Problem(Example[
...
problem_remove_file_extension_from_filename = Problem(Example[
...
problem_remove_leading_and_trailing_spaces_from_text = Problem(Example[
...
problem_remove_unwanted_characters = Problem(Example[
...
problem_replace_one_character_with_another = Problem(Example[
	IOExample(Dict{Symbol, Any}(:_arg_1 => "801 456 8756"), "801-456-8756"), 
	IOExample(Dict{Symbol, Any}(:_arg_1 => "978 456 8756"), "978-456-8756")])
problem_split_numbers_from_units_of_measure_1 = Problem(Example[
...
problem_split_numbers_from_units_of_measure_2 = Problem(Example[
...
problem_split_text_and_numbers = Problem(Example[
...
problem_split_text_string_at_specific_character = Problem(Example[
...
problem_stackoverflow1 = Problem(Example[
...
problem_stackoverflow10 = Problem(Example[
...
problem_stackoverflow11 = Problem(Example[
...
problem_stackoverflow4 = Problem(Example[
...
problem_stackoverflow5 = Problem(Example[
...
problem_stackoverflow6 = Problem(Example[
...
problem_stackoverflow7 = Problem(Example[
...
problem_stackoverflow8 = Problem(Example[
...
problem_strip_non_numeric_characters = Problem(Example[
