...
@testset verbose = true "String_transformations_2020" begin
	...
	@testset verbose = true "Testing string transformations" begin
		@testset "multiple character string" begin
			@test String_transformations_2020.interpret(prim_moveRight, tags, test_state_1) ==
				  StringState("abc", 2)
			@test String_transformations_2020.interpret(prim_moveLeft, tags, test_state_2) ==
				  StringState("abc", 2)
			@test String_transformations_2020.interpret(prim_makeUppercase, tags, test_state_2) ==
				  StringState("abC", 3)
			@test String_transformations_2020.interpret(prim_makeLowercase, tags, test_state_3) ==
				  StringState("abc", 1)
			@test String_transformations_2020.interpret(prim_drop, tags, test_state_1) ==
				  StringState("bc", 1)
		end

		@testset "single character string" begin
			@test String_transformations_2020.interpret(prim_moveRight, tags, test_state_8) ==
				  StringState("a", 1)
			@test String_transformations_2020.interpret(prim_moveLeft, tags, test_state_8) ==
				  StringState("a", 1)
			@test String_transformations_2020.interpret(prim_drop, tags, test_state_8) ==
				  StringState("", 0) # TODO: is that how we want this to behave?
		end

		@testset "empty string" begin
			# pointer at 0
			@test String_transformations_2020.interpret(prim_moveRight, tags, test_state_9) ==
				  StringState("", 0)
			@test String_transformations_2020.interpret(prim_moveLeft, tags, test_state_9) ==
			...
			@test String_transformations_2020.interpret(prim_drop, tags, test_state_9) ==
				  StringState("", -1) # TODO: pointer shouldn't be -1
		end
	end

	@testset verbose = true "Testing string conditions" begin
		@testset "multiple character string" begin
			@test String_transformations_2020.interpret(prim_atEnd, tags, test_state_2) == true
			@test String_transformations_2020.interpret(prim_atEnd, tags, test_state_1) == false &&
				  String_transformations_2020.interpret(prim_notAtEnd, tags, test_state_1) == true
			@test String_transformations_2020.interpret(prim_atStart, tags, test_state_1) == true
			@test String_transformations_2020.interpret(prim_notAtStart, tags, test_state_1) ==
				  false
			@test String_transformations_2020.interpret(prim_notAtStart, tags, test_state_4) ==
				  true &&
				  String_transformations_2020.interpret(prim_notAtEnd, tags, test_state_4) == true
			@test String_transformations_2020.interpret(prim_isLetter, tags, test_state_1) == true
			@test String_transformations_2020.interpret(prim_isLetter, tags, test_state_5) ==
				  false &&
				  String_transformations_2020.interpret(prim_isNotLetter, tags, test_state_5) ==
				  true
			@test String_transformations_2020.interpret(prim_isUppercase, tags, test_state_3) ==
				  true &&
				  String_transformations_2020.interpret(prim_isNotUppercase, tags, test_state_3) ==
				  false
			@test String_transformations_2020.interpret(prim_isLowercase, tags, test_state_1) ==
				  true &&
				  String_transformations_2020.interpret(prim_isNotLowercase, tags, test_state_1) ==
				  false
			@test String_transformations_2020.interpret(prim_isNumber, tags, test_state_6) == true
			@test String_transformations_2020.interpret(prim_isNotNumber, tags, test_state_1) ==
				  true
			@test String_transformations_2020.interpret(prim_isSpace, tags, test_state_6) ==
				  false &&
				  String_transformations_2020.interpret(prim_isNotSpace, tags, test_state_6) == true
		end

		# Test case: single character string
		@test String_transformations_2020.interpret(prim_atEnd, tags, test_state_8) == true &&
			  String_transformations_2020.interpret(prim_atStart, tags, test_state_8) == true
	...
	@testset verbose = true "Testing WHILE, IF, and nested programs" begin
		...
		@test String_transformations_2020.interpret(prog, tags, test_state_1) ==
			  StringState("Abc", 1)
		...
		@test String_transformations_2020.interpret(prog, tags, test_state_10) ==
