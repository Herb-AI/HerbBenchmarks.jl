...
@testset verbose = true "Robots_2020: Testing robot transformations" begin
...
@testset verbose = true "Robots_2020: Testing robot conditions" begin
    @testset "Robot in top left corner" begin
...
@testset verbose = true "Robots_2020: Testing IF, WHILE and nested programs" begin
